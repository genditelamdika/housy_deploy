...
<div style={{marginTop:"50px"}}>
    ...
    <span style={{marginLeft:"150px" }} className="color fs-4 fw-bold">{house?.nameproperty}</span>
</div>
    ...
    <div className="flex" style={{marginLeft:"150px"}}>
      ...
      <h3 style={{fontSize:"20px", width:"180px", fontWeight:"bold", height: "33px",fontFamily: 'Avenir',alignItems:"center"}}> RP {house?.price}/year</h3>
      <div className="" style={{marginLeft:"500px"}}>
      <h3 style={{fontSize:"20px", width:"180px", fontWeight:"bold", height: "33px",fontFamily: 'Avenir',alignItems:"center"}}> bedroom</h3>
     <div className="flex" >
      <h3 style={{height:"20px",fontWeight:"bold",fontFamily: 'Avenir',}}> {house?.bedroom}</h3>
      <img style={{height:"30px"}} src={iconbedroom}/>
     </div>
      </div>   

      <div className="" style={{marginLeft:"10px"}}>
      <h3 style={{fontSize:"20px", width:"180px", fontWeight:"bold", height: "33px",fontFamily: 'Avenir',alignItems:"center"}}> bathroom</h3>
     <div className="flex" >
      <h3 style={{height:"20px",fontWeight:"bold",fontFamily: 'Avenir',}}> {house?.bathroom}</h3>
      <img style={{height:"30px"}} src={bathroom}/>
     </div>
      </div>   

      <div className="" style={{marginLeft:"10px"}}>
      <h3 style={{fontSize:"20px", width:"180px", fontWeight:"bold", height: "33px",fontFamily: 'Avenir',alignItems:"center"}}> Area</h3>
     <div className="flex" >
      <h3 style={{height:"20px",fontWeight:"bold",fontFamily: 'Avenir',}}>{house?.area}</h3>
      {/* <img style={{height:"30px"}} src={ihotel}/> */}
     </div>
      </div>   
      ...
      <p>{house?.addres}</p>
      <div>
      <h3 style={{fontSize:"20px", width:"180px", fontWeight:"bold", height: "33px",fontFamily: 'Avenir',alignItems:"center"}}> decription</h3>
        <p style={{width:"900px"}}>{house?.description}</p>
      </div>

      <div className="flex" style={{marginTop:"50px"}}>

        <Button type="submit"  onClick={handleModalShow}  style={{
            marginBottom:"20px",
        marginLeft:"900px",
        width: "213px",
        height: "50px",
