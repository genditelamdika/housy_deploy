          ...
          >
            ...
            <div className="flex">
              ...
              <div style={{ marginLeft: "0px" }}>
                ...
                >
                  {transactions?.house?.nameproperty}
                </h3>
            ...
            <div className="flex">
              ...
              <h3 style={{ marginLeft: "200px", fontWeight: "bold" }}>
                Long time Rent
              </h3>
              <h3 style={{ marginLeft: "50px", fontWeight: "bold" }}>:</h3>
              <h3 style={{ marginLeft: "40px", fontWeight: "bold" }}>
                1
              </h3>
            </div>
            <div style={{ marginTop: "0", marginBottom: "0" }}>
