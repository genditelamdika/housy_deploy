...
function Pay() {
   ...
   const navigate = useNavigate()
    ...
    return(
      ...
      <div className="flex">
      <h3 style={{fontSize:"20px", width:"180px",color:"#A8A8A8", fontWeight:"bold", height: "33px",fontFamily: 'Avenir',alignItems:"center"}}>{checkin}</h3>
      </div>
      </div>
...
<div>
      ...
      <div className="flex">
      <h3 style={{fontSize:"20px", width:"180px", fontWeight:"bold", height: "33px",color:"#A8A8A8",fontFamily: 'Avenir',alignItems:"center"}}>{house?.amenities}</h3>
      </div>
      </div>
      </div>
      ...
      <div className="flex">
      <h3 style={{fontSize:"20px", width:"180px",color:"#A8A8A8", fontWeight:"bold", fontFamily: 'Avenir',alignItems:"center"}}>{checkout}</h3>
      </div>
      </div>
...
<div>
      ...
      <div className="flex">
      <h3 style={{fontSize:"20px", width:"180px", fontWeight:"bold",color:"#A8A8A8", height: "33px",fontFamily: 'Avenir',alignItems:"center"}}>{house?.year}</h3>
      </div>
      </div>
      <p style={{marginTop:"30px",marginLeft:"20px"}}>15180026</p>
            ...
            <div className="flex">
                ...
                <h3  style={{marginLeft:"30px",fontWeight:"bold",color:"red",paddingBottom:"80px"}}>Rp.{house?.price}</h3>
